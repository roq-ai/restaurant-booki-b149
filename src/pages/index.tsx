  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="With Restaurant Booking Engine, managing table reservations and menus becomes a breeze. Your customers can reserve tables at their convenience, enhancing your restaurant's service."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`With Restaurant Booking Engine, managing table reservations and menus becomes a breeze. Your customers can reserve tables at their convenience, enhancing your restaurant's service.`}
            </Text>
            <Box
